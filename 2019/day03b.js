...
// 610
//var path1 = [ "R75", "D30", "R83", "U83", "L12", "D49", "R71", "U7", "L72" ]
//var path2 = [ "U62", "R66", "U55", "R34", "D71", "R55", "D58", "R83" ];
...
coords1.forEach( function( wire1 ) {
	...
	coords2.forEach( function( wire2 ) {
		...
		if ( wire1.x == wire2.x && wire1.y == wire2.y ) {
			console.log( "cross", wire1.x, wire1.y, w1, w2, w1 + w2 );
			...
			// Calculate Least Steps
			var steps = w1 + w2;
			if ( leastSteps == 0 || leastSteps > steps ) {
				leastSteps = steps;
			}
		}
	} );
...
console.log( "Manhatten Distance", manhattenDistance );
console.log( "Least Steps", leastSteps );
